...
//             <button className="btn min-h-0 h-10">Demo Login</button>
//           </p>
...
const Login = () => {
  ...
  const handleDemoLogin = () => {
    ...
    // Optionally, you can automatically trigger form submission if desired:
    // handleLogin({
    //   preventDefault: () => {}, // Mock the preventDefault method
    //   target: {
